<template>
  <div style="padding: 24px" class="twelve-cause-card" title="Thập Nhị Nhân Duyên (12-linked chain of causation)">
    <UCarousel
        ref="carouselRef"
        :items="items"
        :ui="{
    ...
    >
      <template #default="{ item }">
        <img :src="item.src" :title="item.title" class="w-full" draggable="false">
      </template>
