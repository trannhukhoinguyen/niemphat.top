      ...
      <ul>
        ...
        <li>
          <svg viewBox="0 0 72 200">
            <path d="M0,100 C0,66.6666667 12,33.3333333 36,0 C60,33.3333333 72,66.666667 72,100 C72,133.333333 60,166.666667 36,200 C12,166.666667 0,133.333333 0,100 Z"></path>
          </svg>
        </li>
        <li>
          <svg viewBox="0 0 72 200">
    ...
    <svg class="gradient">
      <defs>
        <radialGradient cx="50%" cy="5%" fx="50%" fy="5%" r="110%" id="gradient">
          <stop stop-color="#FCFDF2" offset="0%"></stop>
          <stop stop-color="#E9BABA" offset="100%"></stop>
        </radialGradient>
      </defs>
    </svg>
  </div>
