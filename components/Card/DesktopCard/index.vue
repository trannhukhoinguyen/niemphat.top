  ...
  <div class="desktop-card-wrapper">
    ...
    <div class="container">
      ...
      <div class="card--open">
        ...
        <p class="description">
          We provide resources, tutorials, and workshops to enhance skills and
        ...
        <button class="button">
          ...
          >
            <path
              d="M5 15.8333L15.8333 4.99999M15.8333 4.99999V15.4M15.8333 4.99999H5.43333"
              stroke="#FFFAFA"
              stroke-width="1.25"
        ...
        <img
          src="https://images.unsplash.com/photo-1682685797406-97f364419b4a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxfHx8ZW58MHx8fHx8&auto=format&fit=crop&w=500&q=60"
          alt=""
          class="showcase"
        />
      </div>
