<template>
  <div class="pool-with-moon-wrapper">
    <div class="landscape">
...
.pool-with-moon-wrapper {
  ...
  *:after {
  ...
  .cloud {
    ...
    border-radius: 50%;
    box-shadow:
      30vmin 0.5vmin 0 -1vmin currentcolor,
  ...
  .reed-1 {
    ...
    box-shadow:
      inset -1px 0 0 var(--s1),
      6vmin 13vmin 0 0 var(--s1),
