      ...
      <svg role="img" xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
        ...
        <defs>
          ...
          <g id="plane">
            ...
            <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Fredoka One' font-size="34" fill="#0170BB"> A Di Đà Phật! A Di Đà Phật!</text>
